...
@IonicPage()
@Component({
    selector: 'organization-stats',
    templateUrl: 'organization-stats.component.html'

})

export class OrganizationStatsComponent implements OnInit, AfterViewInit {
    constructor(private route: ActivatedRoute,
        ...
        this.dataPassService.leadIcon="./assets/images/home/home-screen/org-stats";
    }
    ngOnInit() {
        this.calculateHomeData.calculateOrganizationStats();
    }
    ngAfterViewInit() {
    }
}
