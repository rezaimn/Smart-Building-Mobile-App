...
export class VisitorStatsComponent implements OnInit, AfterViewInit {
    ...
    constructor(private  httpService: HttpService,
        ...
        this.dataPassService.leadIcon="./assets/images/home/home-screen/visitor";
    }
    ngOnInit() {

        this.calculateHomeData.calculateVisitorStats();
    }
