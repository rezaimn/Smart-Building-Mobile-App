...
@IonicPage()
@Component({
    selector: 'safety-status',
    templateUrl: 'safety-status.component.html'

})

export class SafetyStatusComponent implements OnInit, AfterViewInit {
    ...
    constructor(private  httpService:HttpService,
        ...
        this.dataPassService.leadIcon="./assets/images/home/home-screen/safety";
    }
    ngOnInit() {

        this.calculateHomeData.calculateSafetyStatus();
